package com.tmholter.pediatrics.xhjdemo.common.presentation.presenter.base;

import android.content.Context;

import com.tmholter.pediatrics.xhjdemo.AndroidContext;


public interface BasePresenter {

    Context mContext = AndroidContext.instance().get();
